...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                textAction.text = getString(R.string.selectText)
                lemonImage?.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                textAction.text = getString(R.string.juiceText)
                lemonImage?.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                textAction.text = getString(R.string.drinkText)
                lemonImage?.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                textAction.text = getString(R.string.restartText)
